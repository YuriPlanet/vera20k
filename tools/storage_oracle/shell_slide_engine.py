...
if __name__ == "__main__":
    finish_vectors(generate, Path(__file__).with_suffix(".json"),
        ...
        assumptions=[
            "Visible top-button and bottom-button counts per dialog are supplied (0xE2 5+1, 0x100 and 0x101 3+1, 0x129 1+1, 0x102 2+1); the classifier callbacks 0x0060A180/0x0060A250 are not executed",
