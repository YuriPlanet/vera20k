...
def unit_manager_cases():
    ...
    return [
        ...
        dict(unit, name='mu1_field', manager_state=1, ore=[FIELD], passable=[[21, 13]]),
        dict(unit, name='mu1_no_deploy_cell', manager_state=1, ore=[FIELD], passable=[None]),
        dict(unit, name='mu1_on_ore', manager_state=1, ore=[[15, 15, 0, 0, 5]], passable=[[16, 13]]),
...
def unit_helper_cases():
    ...
    return [
        ...
        dict(unit, name='hr_nav_field', helper='handle_returned', manager_state=0, owner_nav=[20, 15],
             owner_mission='harvest', ore=[FIELD], passable=[[21, 13]], nodes=out),
