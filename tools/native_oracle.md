...
| `tools.spatial_oracle.aircraft_attack_release` | 316 original admitted state4 burst loops and post-reveal state/delay branches, plus 72 state1/3/10 pending-ammo entry prefixes; selection/FireAt supplied and reveal excluded | Evidence for the open mission/emission migration; native pending-before-fire and caller continuation, not emitted-shot, damage or scheduling parity |
