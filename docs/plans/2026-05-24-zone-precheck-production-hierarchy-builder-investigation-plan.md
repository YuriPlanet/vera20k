...
| [LOW_BRIDGE_ZONE_PRECHECK_LANDTYPE10_CONNECTIVITY_GHIDRA_REPORT.md](https://github.com/YuriPlanet/vera20k/blob/1dbaf80c89c9348df493ab618dbefed8663aef96/docs/research/bridges/02-cell-state-layering-zones/LOW_BRIDGE_ZONE_PRECHECK_LANDTYPE10_CONNECTIVITY_GHIDRA_REPORT.md) | Low bridge records included in hierarchy and precheck. | High. | Guardrail only; do not conflate low tubes with explicit direction-8 jumps. |
