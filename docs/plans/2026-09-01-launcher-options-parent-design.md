...
- The parent exposes Display, Game, UI, Audio groups and Back/Network/Keyboard with exact local CSF fallback text. Initial Detail/Difficulty/Scroll captions remain resource captions until the first changed thumbtrack. Trigger: every open/slider use. [report §§5.2, 5.3, 8; retail RT_DIALOG `0xD5`; active `ra2md.csf`]
