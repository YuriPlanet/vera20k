...
| [HARVESTER_DOCK_UNLOAD.md](https://github.com/YuriPlanet/vera20k/blob/1dbaf80c89c9348df493ab618dbefed8663aef96/docs/research/miner/HARVESTER_DOCK_UNLOAD.md) | Dock pad coords, CanDock conditions, dock queue mechanics | MED | `DepositOreFromStorage` not analysed; credit-award path incomplete |
