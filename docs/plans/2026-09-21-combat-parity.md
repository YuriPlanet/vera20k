...
| jumpjet_infantry_crash | the Infantry kill (Stun `4D5660`, Stop_Driver `51DAF0`, Crash `4DEBB0`), then per frame the Health reset `51BC57`, the stage tick `6FABC4`, Process `54AEC0` with the impact notice `522A60`, the sequencer and `520F40` | 8 (210 frames) | radio, Detach_All, KillPassengers, SetHeight, UnInit seamed; no mission or scans; no bridge |
