...
- **UnitClass / FootClass::Process** — dispatches to locomotor.vtable[0x40] (Process) each tick (see [FOOTCLASS_PATHFINDING_AND_MOVEMENT.md](https://github.com/YuriPlanet/vera20k/blob/1dbaf80c89c9348df493ab618dbefed8663aef96/docs/research/pathfinding/FOOTCLASS_PATHFINDING_AND_MOVEMENT.md) and [FOOTCLASS_AI_GHIDRA_REPORT.md](https://github.com/YuriPlanet/vera20k/blob/108924bc237d14342b68b8bb78f2bba0400d2443/docs/research/FOOTCLASS_AI_GHIDRA_REPORT.md)).
