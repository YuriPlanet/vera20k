...
impl Simulation {
    ...
    pub(crate) fn tick_c4_plants_with_overlay_registry(
        ...
        for (attacker_id, target_id) in walkup {
            ...
            // with `GetROF(1)`, one Scenario draw (`InfantryClass::PerCellProcess
            ...
            // walk-up leaves hovering outside. Trigger: every Tanya or SEAL
            // plant. Effect: the planter can fire a reload early, and one draw
            // per plant is missing. Needs GetROF as a callable owner.
